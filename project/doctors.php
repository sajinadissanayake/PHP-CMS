...
<div class="divL" style="margin-left: 0%;">
    ...
    <h1 align="center" style="color: white;">doctors Details</h1><br><br>
...
<tbody>
  <?php foreach ($files as $file): ?>
    <tr>
      ...
      <td><a href="doctors.php?file_id=<?php echo $file['NIC'] ?>">Download</a></td>
      <td><a href="doctordelete.php?NIC=<?php echo $file['NIC'] ?>" class = 'btn btn-danger'>Delete</a></td>
      <td><a href="doctorupdate.php?NIC=<?php echo $file['NIC'] ?>" class = 'btn btn-danger'>update</a></td>
