...
include 'config.php';
$ID = $_GET['Rnumber'];
$Record = mysqli_query($con,"SELECT * FROM `pharmacy` WHERE Rnumber=$ID");
...
<div class="divL">
    ...
    <h1 align="center" style="color: white;">Pharmacy Update</h1>
  <div class="divpatient">
  <form action="pharmacyupdate1.php"  method="post" enctype="multipart/form-data">
