...
<div class="divL" style="margin-left: 0%;">
    ...
    <h1 align="center" style="color: white;">Laboratory Details</h1><br><br>
...
<tbody>
  <?php foreach ($files as $file): ?>
    <tr>
      ...
      <td><a href="lab.php?file_id=<?php echo $file['Rnumber'] ?>">Download</a></td>
      <td><a href="labsdelete.php?Rnumber=<?php echo $file['Rnumber'] ?>" class = 'btn btn-danger'>Delete</a></td>
      <td><a href="labupdate.php?Rnumber=<?php echo $file['Rnumber'] ?>" class = 'btn btn-danger'>update</a></td>
