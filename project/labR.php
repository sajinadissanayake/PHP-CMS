...
<div class="divL">
    ...
    <h1 align="center" style="color: white;">laboratory Registration</h1>
  <div class="divpatient">
  <form action="labR.php"  method="post" enctype="multipart/form-data">
  ...
  <div class="divpatient">
  <form action="labR.php" method="post">
    <label for="Laboratory ID">Laboratory ID</label>
    <input type="text" id="LaboratoryID" name="LabID" placeholder="Laboratory ID..">

    <label for=" laboratoryUsername">Laboratory Username</label>
    <input type="text" id="laboratoryUsername" name="username" placeholder="laboratoryUsername..">

    <label for="Laboratoypassword">Create Password</label>
    <input type="text" id="Laboratoypassword" name="password" placeholder="Create password">

   <label for="Laboratoypassword">Confirm Password</label>
    <input type="text" id="Laboratoypassword" name="Laboratoypassword" placeholder="Confirm password">
