...
<div class="divL">
  ...
  <form  method="post">
    ...
    <input type="text" id="patientID" name="search" placeholder="Enter Report Type to see reports.."style="width: 500px;">
  ...
  <div class ="container my-5">
    <table class="table">
       ...
       if (isset($_POST['submit'])){
        ...
        $sql="Select * from `reports` where type like '%$search%' and Pnic=$name";
