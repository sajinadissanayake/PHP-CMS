...
<div class="divL">
    ...
    <h1 align="center" style="color: white;">Contact Doctors</h1>
  <div class="divpatient">

  <form  method="post">
   
    <input type="text" id="patientID" name="search" placeholder="Enter the doctor name or city to see the results.."style="width: 500px;">
  ...
  <div class ="container my-5">
    <table class="table">
       ...
       if (isset($_POST['submit'])){
        $search=$_POST['search'];
        $sql="Select * from `doctors` where HomeTown like '%$search%'or Fname like '%$search%' or Lname like '%$search%'";
